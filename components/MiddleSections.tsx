        ...
        <>
                                ...
                                <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
                                    <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                                        <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)]
                                            shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-8 w-8 circle-1 flex items-center justify-center bounce delay-1"
                                            style={{ willChange: 'transform', transform: 'translateY(0px)' }}>
                                            <img src="/assets/Anthropic.png" alt="Logo 1" className="w-3/4 h-3/4 object-contain" />
                                        </div>
                                        <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)]
                                            shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-12 w-12 circle-2 flex items-center justify-center bounce delay-2"
                                        ...
                                        <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)]
                                            shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-16 w-16 circle-3 flex items-center justify-center bounce delay-3"
                                            style={{ willChange: 'transform', transform: 'translateY(0px)' }}>
                                            <img src="/assets/OpenAI.png" alt="Logo 3" className="w-3/4 h-3/4 object-contain" />
                                        </div>
                                        <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)]
                                            shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-12 w-12 circle-4 flex items-center justify-center bounce delay-4"
                                            style={{ willChange: 'transform', transform: 'translateY(0px)' }}>
                                            <img src="/assets/Mistral.png" alt="Logo 4" className="w-3/4 h-3/4 object-contain" />
                                        </div>
                                        <div className="rounded-full flex items-center justify-center bg-[rgba(248,248,248,0.01)]
                                            shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)] h-8 w-8 circle-5 flex items-center justify-center bounce delay-5"
                                            style={{ willChange: 'transform', transform: 'translateY(0px)' }}>
            ...
            <div className="mx-auto px-4 max-w-7xl">
                <div className="mt-40 flex flex-col md:flex-row items-center">
                    <div className="md:w-1/3 pr-4">
                        <div
                            className="max-w-sm w-full p-8 bg-[var(--color-offwhite1)] border-[var(--color-offwhite3)] border rounded-xl shadow flex flex-col justify-center items-center"
                            style={{ height: '300px' }}
                        >
                            <div className="text-center">
                                <p className="text-6xl font-bold mb-2">
                                    ...
                                    <span className="inline-block tabular-nums tracking-wider">
                                        <CountUp start={0} end={90} duration={5} enableScrollSpy>
                                        {({ countUpRef }) => (
                                            <span ref={countUpRef} />
                                        )}
                                        </CountUp>
                                ...
                                <p className="text-sm italic">Correlation with human grader</p>
                            </div>
                        </div>
                    </div>
                    <div className="md:w-2/3 pl-4 mt-8 md:mt-0 flex flex-col justify-center">
                        <p className="font-bold tracking-tight text-4xl">
                            Align with human graders for <span className="highlight font-bold md:extrabold">trustworthy</span> results
                        </p>
                        <p className="mt-5 text-lg text-gray-500">
            ...
            <div className="mx-auto max-w-7xl mb-[10%] px-6 lg:px-8 pt-40 flex flex-col md:flex-row">
                <div className="md:w-2/3 md:pr-8 mb-8 md:mb-0 flex flex-col justify-center">
                    <div>
                    <h2 className="text-center md:text-left font-bold tracking-tight text-4xl mb-4">
                        Integrate <span className="highlight font-bold md:extrabold">anywhere</span>
                    </h2>
                ...
                <div className="md:w-1/3">
                    <div className="px-[5%] bg-[var(--color-offwhite1)] border-[var(--color-offwhite3)] rounded-xl border shadow">
                            ...
                            <div className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg bg-background">
                                <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
                                    <div className="flex flex-row items-center justify-between">
                                        <div
                                            id="top-left-img"
                                            className="z-20 flex size-12 items-center justify-center rounded-full bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] borderOffwhite3"
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                                                <circle cx="15.5" cy="16.5" r="3.5" fill="currentColor" />
                                                <circle cx="15.5" cy="6.5" r="3.5" fill="currentColor" />
                                                <circle cx="6.5" cy="11.5" r="3.5" fill="currentColor" />
                                            </svg>
                                        </div>
                                        <div
                                            id="top-right-img"
                                            ...
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="/assets/LlamaIndexLogo.svg" alt="Llama index Logo" />
                                        </div>
                                    </div>
                                    <div className="flex flex-row items-center justify-between">
                                        <div
                                            ...
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="https://uploads-ssl.webflow.com/65ff950538088944d66126b3/662ef3209b872e92e41212f6_cookieicon.png" alt="LangSmith" />
                                        </div>
                                        <div
                                            id="middle-img"
                                            className="z-20 flex size-12 items-center justify-center rounded-full bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] borderOffwhite3 size-16"
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="/assets/halluminatesinglelogo.svg" alt="Halluminate Logo" className="w-[75%]" />
                                        </div>
                                        <div
                                            id="middle-right-img"
                                            className="z-20 flex size-12 items-center justify-center rounded-full bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] borderOffwhite3"
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="/assets/AgentopsLogo.png" alt="AgentOps Logo" />
                                        </div>
                                    </div>
                                    <div className="flex flex-row items-center justify-between">
                                        <div
                                            ...
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="https://arize.com/wp-content/themes/arize-2022/images/favicon.png" alt="Arize Logo" />
                                        </div>
                                        <div
                                            id="bottom-right-img"
                                            className="z-20 flex size-12 items-center justify-center rounded-full bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] borderOffwhite3"
                                            style={{ backgroundColor: 'white' }}
                                        >
                                            <img src="/assets/vscode.svg" alt="Visual Studio Code Logo" />
                                        </div>
                                    </div>
                                    <Xarrow
                                        start="top-left-img"
                                        ...
                                        color='#e8e8e8'
                                        strokeWidth={2}
                                        startAnchor={{ position: 'bottom', offset: { x: 15, y: -10 } }}
                                        endAnchor={{position: 'middle', offset: { x: 0, y: -5 }}}
                                    />
                                    <Xarrow
                                        start="top-right-img"
                                        end="middle-img"
                                    ...
                                    <Xarrow
                                        ...
                                        color='#e8e8e8'
                                        strokeWidth={2}
                                        startAnchor={{ position: 'top', offset: { x: 15, y: 10 } }}
                                        endAnchor={{position: 'middle', offset: { x: 0, y: 5 }}}
                                    />
                                    <Xarrow
